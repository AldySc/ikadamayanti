                        ...
                        <div class="form-group row align-items-center">
                          ...
                          <div class="col-lg-4 col-md-6">
                             <select name="id_kelas">
                                    ...
                                    {
                                    ?>
                                  <option value="<?php echo $row['id_kelas']; ?>" <?php if($row['id_kelas']=="$'id_kelas'yangdipilih"){?> selected="selected" <?php } ?>><?php echo $row['nama_kelas']; ?></option>
                               <?php
                          ...
                          <div class="col-lg-4 col-md-6">
                             <select name="tahun" disabled="">
                                    ...
                                    {
                                    ?> 
                                  <option value="<?php echo $row['id_spp']; ?>" <?php if($row['id_spp']=="$'id_kelas'yangdipilih"){?> selected="selected" <?php } ?>><?php echo $row['tahun']; ?></option>
                               <?php
                                      $no++; //untuk nomor urut terus bertambah 1
                                    }
                                    ?>
